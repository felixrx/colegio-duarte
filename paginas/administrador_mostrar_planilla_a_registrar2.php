...
<script type="text/javascript">
    $(document).ready(function(){
        $('#registrar_evaluacion2').modal('show');
    });
</script>
...
<div class="modal fade" id="registrar_evaluacion2" role="dialog"  style="display:open;">
<div  id="modal-dialog_notas" class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title"><h2>Registrar de Evaluacion</h2> </div>
...
<form action='../procesos/procesar_notas_a_ingresar.php' method='post'>
