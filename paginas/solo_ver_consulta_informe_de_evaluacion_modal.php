...
<div class="row" id="row">
                  ...
                  <div id="cont4" class="col-sm-4" ><a href="#myModalBuscar2" data-toggle="modal"><img class="zoom" src="registar.png" align="center" width=70 heigth=70 /> </a><p id="parrafo" class="zoom"> Planilla de Inscripcion </p></div>


                  <div id="cont4" class="col-sm-4"><a href="#myModalBuscar" data-toggle="modal"><img  class="zoom" src="buscar.png" width=70 heigth=70 /></a><p id="parrafo" class="zoom">Consultar Notas</p></div>
...
<div class="modal fade" id="myModalBuscar" role="dialog"  style="display:open;">
    ...
    <form  action="solo_ver_consulta_informe_de_evaluacion_modal.php" method="POST" >
...
<div class="modal fade" id="myModalBuscar2" role="dialog"  style="display:open;">
    ...
    <div  id="modal-dialog"  class="modal-dialog">
      ...
      <!-- Modal content boton buscar-->
      <div class="modal-content"  id="notas_modal">
