...
<script type="text/javascript">
    $(document).ready(function(){
        $('#myModalBuscar_nota2').modal('show');
    });
</script>
...
<div class="modal fade" id="myModalBuscar_nota2" role="dialog"  style="display:open;">
<div  id="modal-dialog_notas" class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title"><h2>Informe de Evaluacion</h2> </div>
...
<table class="tabla" width="721"  border="1" >
  ...
  <tr>
    <td class="celda">1</td>
    <td  class="celda" ><select disabled name='asignatura_1' value='<?php echo $asignatura_1?>' class="selector"> class="selector">
