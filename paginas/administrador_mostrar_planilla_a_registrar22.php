...
<div class="container">
        ...
        <div class=""  id=""> 
             ...
             <div class="row" id="row">
                 ...
                 <div id="cont3" class="col-sm-4" ><a href="#myModalReporte" data-toggle="modal"><img class="zoom" src="registar.png" width=70 heigth=70 /> </a><p id="parrafo" class="zoom2"><h4> Modulo Inscripcion</h4> </div>
