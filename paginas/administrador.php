...
<?php
  ...
  include_once('../login/acceso.php'); //  Importa o inserta el código contenido en el archivo.php dentro de otro. El _once impide la carga de un mismo archivo más de una vez.
?>
...
<hr>
    ...
    <div  id="cedula" class="form-group">
      ...
      <label >Cedula:</label>
<br>
    <input type="text" name='id_c'  class="form-control" onFocus="nextfield ='nb';" onKeyPress="return validar(event)"  maxlength="8" placeholder="Cedula"    >
    </div>
...
<br>
      ...
      <input type="text"  name='nb' style="text-transform:capitalize;" onblur="javascript:this.value=this.value.capitalize();" onKeyPress="return validarM(event)" onFocus="nextfield ='ap';" class="form-control"  placeholder="Nombres">
...
<br>
      ...
      <input type="text" name="ap" onFocus="nextfield ='fc_n'"  class="form-control"  placeholder="Apellidos">
    </div>
...
<br>
      ...
      <input type="date"   name='fc_n'  value="fc_n" class="form-control" id="fc_n" onFocus="nextfield ='eda'" placeholder="Fecha">
    </div>
...
<br>
      ...
      <input type="number" name='eda'  class="form-control" onFocus="nextfield ='gene'" placeholder="Edad">
    </div>
...
<br>
      <input id="input_entidad"  type="text" class="form-control" name='ent_f' onFocus="nextfield ='esta_ci'" placeholder="Etidad Federal">
    </div>
...
<br>
      ...
      <input  id="input_peso" type="number" name='pso' class="form-control"  onFocus="nextfield ='impedi_f'" placeholder="Peso">
    </div>
...
<br>
      ...
      <input type="text" class="form-control" name='impedi_f' onFocus="nextfield ='dir_ha'" placeholder="Impedimento Fisico">
    </div>
...
<br>
      ...
      <input type="text" id="input_direccion"  name='dir_ha' class="form-control" onFocus="nextfield ='muni'" placeholder="Direccion de Habitacion">
    </div>
...
<br>
      ...
      <input type="text"  name='muni' class="form-control" onFocus="nextfield ='parro'" placeholder="Municipio">
    </div>
...
<br>
      ...
      <input type="text"  name='parro' class="form-control" onFocus="nextfield ='tel_h'" placeholder="Parroquia">
    </div>
...
<br>
      ...
      <input type="text"  name='tel_h' class="form-control"  onFocus="nextfield ='tel_m'" placeholder="Telefono de Habitacion">
    </div>
...
<br>
      ...
      <input type="text"  name='tel_m'  class="form-control" onFocus="nextfield ='corr'" placeholder="Telefono Movil">
    </div>
...
<br>
      ...
      <input  id="input_correo" type="text"  name='corr' class="form-control" onFocus="nextfield ='etni'" placeholder="Correo">
    </div>
...
<br>
      ...
      <input type="text"   name='etni' class="form-control" onFocus="nextfield ='alergi'" placeholder="Etnia">
    </div>
...
<br>
      ...
      <input type="text" id="input_correo" name='alergi' class="form-control" onFocus="nextfield ='plan'" placeholder="Alergico a algun medicamento">
    </div>
...
<br>
      ...
      <input type="text" id="input_plantel"  name='plan' class="form-control" onFocus="nextfield ='be'" placeholder="Plantel">
    </div>
...
<br>
    ...
    <div id="input_organismo" class="form-group">
      ...
      <label  id="input_organismo">smo:</label>
<br>

      <input type="text"  name='org' class="form-control" onFocus="nextfield ='cd_r'" placeholder="organismo">
    </div>
...
<br>
    <input type="text"  name='cd_r' class="form-control" onFocus="nextfield ='nb_r'" placeholder="Cedula">
    </div>
...
<br>
      <input type="text" name='nb_r'  class="form-control" onFocus="nextfield ='ap_r'" placeholder="Nombres">
    </div>
...
<br>
      ...
      <input type="text" name="ap_r"   class="form-control" onFocus="nextfield ='fec_r'" placeholder="Apellidos">
    </div>
...
<br>
      ...
      <input type="date"  name='fec_r' value="fec_r" class="form-control"  onFocus="nextfield ='eda_r'" placeholder="Apellidos">
    </div>
...
<br>
      ...
      <input type="number" name='eda_r' class="form-control" onFocus="nextfield ='ge_r'" placeholder="Edad">
    </div>
...
<br>
      ...
      <input type="text" name="parent" class="form-control" onFocus="nextfield ='cor_re'" placeholder="Parentesco">
    </div>
...
<br>
      ...
      <input type="text" id="input_correo" name="cor_re"   class="form-control" onFocus="nextfield ='dir_ha_r'" placeholder="Correo">
    </div>
...
<br>
      ...
      <input type="text" id="input_direccion" name='dir_ha_r'  class="form-control" onFocus="nextfield ='muni_r'" placeholder="Direccion de Habitacion">
    </div>
...
<br>
      ...
      <input type="text" name='muni_r'  class="form-control" onFocus="nextfield ='parro_r'" placeholder="Municipio">
    </div>
...
<br>
      ...
      <input type="text" name='parro_r'  class="form-control" onFocus="nextfield ='tel_h_r'"  placeholder="Parroquia">
    </div>
...
<br>
      ...
      <input type="text"  name='tel_h_r' class="form-control" onFocus="nextfield ='tel_m_r'" placeholder="Telefono de Habitacion">
    </div>
...
<br>
      ...
      <input type="text" name="tel_m_r"  class="form-control" onFocus="nextfield ='nb_m'"placeholder="Telefono Movil">
    </div>
...
<br>
    <input type="text"  name='nb_m' class="form-control" onFocus="nextfield ='cd_m'" placeholder="Nombre Madre">
    </div>
...
<br>
      <input type='text'  name='cd_m' class="form-control" onFocus="nextfield ='tel_m_m'" placeholder="Cedula">
    </div>
...
<br>
      ...
      <input type="text" name='tel_m_m'   class="form-control"   onFocus="nextfield ='nb_p'" placeholder="Telefono Movil">
    </div>
...
<br>
    <input type='text' name='nb_p'  class="form-control" onFocus="nextfield ='cd_p'" placeholder="Nombre Padre">
    </div>
...
<br>
      <input type="text" name='cd_p'  class="form-control" onFocus="nextfield ='tel_m_p'" placeholder="Cedula">
    </div>
