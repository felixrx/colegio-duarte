...
<br>
      ...
      <select class="form-control"  name='lu_n'  onKeyDown="A(event,this.form.ent_f);">
                      ...
                      <option value="Venezuela"    <?php if($datos->lu_n=="Venezuela") echo "selected";?>>Venezuela</option>  
...
<div  id="modal-dialog_notas2" class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title"><h2></h2> </div>
...
<table class="tabla" width="900" border="1" align="center">
      ...
      <tr align="center">
          <td class="celda1" bgcolor="#CCCCCC">CEDULA</td>
          <td class="celda1" bgcolor="#CCCCCC">NOMBRE</td>
          <td class="celda1" bgcolor="#CCCCCC">APELLIDO</td>
            <td class="celda1" bgcolor="#CCCCCC">CORREO</td>
            <td class="celda1" bgcolor="#CCCCCC">TELEFONO</td>
