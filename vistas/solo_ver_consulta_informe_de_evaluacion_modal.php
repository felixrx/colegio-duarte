    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Consultar Notas</h4>  </div>
...
<input type='submit' value='Regresar' >
    ...
    <form name="f_prac"  action="#myModalReporte" style="display:open;" >


  <div align="center">

    <p><strong> Cedula del alumno a Consultar:
...
<input type="submit" value="BUSCAR"  id="hide" class="btn btn-default" data-dismiss="modal">
