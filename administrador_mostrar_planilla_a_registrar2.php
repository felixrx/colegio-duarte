    ...
    <div  id="modal-dialog" class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h3 align="center" aline class="modal-title"><b>PLANILLA DE INSCRIPCION  33</b></h3>
...
<br>
      ...
      <input required type="text"  name='nb' style="text-transform:capitalize;" onblur="javascript:this.value=this.value.capitalize();" onKeyPress="return validarM(event)" onKeyDown="A(event,this.form.ap);" class="form-control"  placeholder="Nombres">
...
<br>
      ...
      <input required type="text" name="ap"   class="form-control" onKeyDown="A(event,this.form.fc_n);" placeholder="Apellidos">
    </div>
...
<input required id="boton" type='submit' value='Guardar' >
</div>
