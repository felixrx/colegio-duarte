...
$pdf->SetFont('Arial','',9);
	$pdf->Text(15,71, utf8_decode('imponen las leyes  y  el  Reglamento   Interno   o   Normativa escolar,  asi   como todas  aquellas Disposiones') ,0,'J');


$pdf->SetFont('Arial','',9);
	$pdf->Text(15,76, utf8_decode('emanadas de las autoridades  del  plantel,  cancelaré el valor de las reparaciones de los bienes o sustitucion, que') ,0,'J');

$pdf->SetFont('Arial','',9);
	$pdf->Text(15,82, utf8_decode('por mala conducta o negligencia  ocasione mi  Representado(a). Me comprometo a  asistir al plantel, por lo menos  ') ,0,'J');

	$pdf->SetFont('Arial','',9);
	$pdf->Text(15,88, utf8_decode('una (1) vez al mes  y a  asistir puntualmente  a las  reunines  que se convoque para informacion sobre: Conducta,') ,0,'J');
	

	$pdf->SetFont('Arial','',9);
	$pdf->Text(15,94, utf8_decode('Rendimiento  y  Aistencia  de  mi  Representado(a)  Por otra  parte,  acepto  que  despues  que  mi  Representado  ') ,0,'J');



$pdf->SetFont('Arial','',9);
	$pdf->Text(15,100, utf8_decode('abandone el plantel por lo cualquier causa, este no se responasibiliza por el mismo.') ,0,'J');
...
$pdf->SetFont('Arial','',9);
 ...
 $pdf->SetFont('Arial','',9);
	$pdf->Text(15,182, utf8_decode('con la normas de convivencia social establecidas por la institucion, para garantizar el normal desenvolvimiento') ,0,'J');
	$pdf->SetFont('Arial','',9);
	$pdf->Text(15,187, utf8_decode('de las actividades academicas.') ,0,'J');
