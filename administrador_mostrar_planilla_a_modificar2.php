...
<script type="text/javascript">
    $(document).ready(function(){
        $('#modificar_evaluacion2').modal('show');
    });
</script>
...
<hr>
    ...
    <div  id="cedula" class="form-group">
      ...
      <label >Cedula:</label>
<br>
    <input  required type="text" name='id_c'  class="form-control" onKeyDown="A(event,this.form.nb);" onKeyPress="return validar(event)"  maxlength="8" placeholder="Cedula"    >
    </div>
...
<br>
      ...
      <input  requiered type="text"  name='nb' style="text-transform:capitalize;" onblur="javascript:this.value=this.value.capitalize();" onKeyPress="return validarM(event)" onKeyDown="A(event,this.form.ap);" class="form-control"  placeholder="Nombres">
...
<br>
      ...
      <input  requiered type="text" name="ap"   class="form-control" onKeyDown="A(event,this.form.fc_n);" placeholder="Apellidos">
    </div>
...
<br>
      ...
      <input  requiered type="date"   name='fc_n'  value="fc_n" class="form-control" id="fc_n" onKeyDown="A(event,this.form.eda);" placeholder="Fecha">
    </div>
...
<br>
      ...
      <input  requiered type="number" name='eda'  class="form-control" onKeyDown="A(event,this.form.gene);" placeholder="Edad">
    </div>
...
<br>
      <input  requiered type="text" class="form-control" name='ent_f' onKeyDown="A(event,this.form.esta_ci);" placeholder="Etidad Federal">
    </div>
...
<br>
      ...
      <input  requiered type="number" name='pso' class="form-control"  onKeyDown="A(event,this.form.impdi_f);" placeholder="Peso">
    </div>
...
<br>
      ...
      <input  requiered type="text" class="form-control" name='impdi_f' onKeyDown="A(event,this.form.dir_ha);" placeholder="Impedimento Fisico">
    </div>
...
<br>
      ...
      <input  requiered type="text"  name='dir_ha' class="form-control" onKeyDown="A(event,this.form.muni);" placeholder="Direccion de Habitacion">
    </div>
...
<br>
      ...
      <input  requiered type="text"  name='muni' class="form-control" onKeyDown="A(event,this.form.parro);" placeholder="Municipio">
    </div>
...
<br>
      ...
      <input  requiered type="text"  name='parro' class="form-control" onKeyDown="A(event,this.form.tel_h);" placeholder="Parroquia">
    </div>
...
<br>
      ...
      <input  requiered type="text"  name='tel_h' class="form-control"onKeyDown="A(event,this.form.tel_m);" placeholder="Telefono de Habitacion">
    </div>
...
<br>
      ...
      <input  requiered type="text"  name='tel_m'  class="form-control" onKeyDown="A(event,this.form.corr);" placeholder="Telefono Movil">
    </div>
...
<br>
      ...
      <input  requiered type="text"  name='corr' class="form-control" onKeyDown="A(event,this.form.etni);" placeholder="Correo">
    </div>
...
<br>
      ...
      <input  requiered type="text"   name='etni' class="form-control" onKeyDown="A(event,this.form.alrgi);" placeholder="Etnia">
    </div>
...
<br>
      ...
      <input  requiered type="text"  name='alergi' class="form-control" onKeyDown="A(event,this.form.plan);" placeholder="Alergico a algun medicamento">
    </div>
...
<br>
      ...
      <input  requiered type="text"  name='plan' class="form-control" onKeyDown="A(event,this.form.be);" placeholder="Plantel">
    </div>
...
<br>
      ...
      <input  requiered type="text"  name='org' class="form-control" onKeyDown="A(event,this.form.cd_r);" placeholder="organismo">
    </div>
...
<br>
    <input  requiered type="text"  name='cd_r' class="form-control" onKeyDown="A(event,this.form.nb_r);" placeholder="Cedula">
    </div>
...
<br>
      <input  requiered type="text" name='nb_r'  class="form-control" onKeyDown="A(event,this.form.ap_r);" placeholder="Nombres">
    </div>
...
<br>
      ...
      <input  requiered type="text" name="ap_r"   class="form-control" onKeyDown="A(event,this.form.fec_r);" placeholder="Apellidos">
    </div>
...
<br>
      ...
      <input  requiered type="date"  name='fec_r' value="fec_r" class="form-control"  onKeyDown="A(event,this.form.eda_r);" placeholder="Apellidos">
    </div>
...
<br>
      ...
      <input  requiered type="number" name='eda_r' class="form-control" onKeyDown="A(event,this.form.ge_r);" placeholder="Edad">
    </div>
...
<br>
      ...
      <input  requiered type="text" name="parent" class="form-control" onKeyDown="A(event,this.form.cor_re);" placeholder="Parentesco">
    </div>
...
<br>
      ...
      <input  requiered type="text"  name="cor_re"   class="form-control" onKeyDown="A(event,this.form.dir_ha_r);" placeholder="Correo">
    </div>
...
<br>
      ...
      <input  requiered type="text" name='dir_ha_r'  class="form-control" onKeyDown="A(event,this.form.muni_r);" placeholder="Direccion de Habitacion">
    </div>
...
<br>
      ...
      <input  requiered type="text" name='muni_r'  class="form-control" onKeyDown="A(event,this.form.parro_r);" placeholder="Municipio">
    </div>
...
<br>
      ...
      <input  requiered type="text" name='parro_r'  class="form-control"onKeyDown="A(event,this.form.tel_h_r);"  placeholder="Parroquia">
    </div>
...
<br>
      ...
      <input  requiered type="text"  name='tel_h_r' class="form-control" onKeyDown="A(event,this.form.tel_m_r);"placeholder="Telefono de Habitacion">
    </div>
...
<br>
      ...
      <input  requiered type="text" name="tel_m_r"  class="form-control" onKeyDown="A(event,this.form.nb_m);" placeholder="Telefono Movil">
    </div>
...
<br>
    <input  requiered type="text"  name='nb_m' class="form-control" onKeyDown="A(event,this.form.cd_m);" placeholder="Nombre Madre">
    </div>
...
<br>
      <input  requiered type='text'  name='cd_m' class="form-control" onKeyDown="A(event,this.form.tel_m_m);" placeholder="Cedula">
    </div>
...
<br>
      ...
      <input  requiered type="text" name='letra'   class="form-control"  placeholder="Telefono Movil">
    </div>
...
<br>
    <input  requiered type='text' name='nb_p'  class="form-control" onKeyDown="A(event,this.form.cd_p);" placeholder="Nombre Padre">
    </div>
...
<br>
      <input  requiered type="text" name='cd_p'  class="form-control" onKeyDown="A(event,this.form.tel_m_p);" placeholder="Cedula">
    </div>
...
<br>
      ...
      <input  requiered type="text" name='tel_m_p' class="form-control"  placeholder="Telefono Movil">
    </div>
...
<br>
    ...
    <input  requiered type="submit" id="guardar" value="GUARDAR" name="guardar">
</form>
...
<div>
    ...
    <div class="checkbox">
      <label><input  requiered type="checkbox"> Recordar</label>
    </div>
...
<div class="modal fade" id="myModalBuscar_nota" role="dialog"  style="display:open;">
  ...
  <div align="center">
    ...
    <p><strong>Consultar de cedula:
      ...
      <input  requiered type="text" name="id_c" id="id_c">
...
<input  requiered type="submit" value="BUSCAR" name="ELIMINAR" >
...
<div class="modal fade" id="modificar_evaluacion2" role="dialog"  style="display:open;">
<div  id="modal-dialog_notas" class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title"><h2>Informe de Evaluacion a Modificar</h2> </div>
...
<form action='procesos/procesar_notas_a_modificar.php' method='post'>
...
<br>
<input  requiered class="input2" type="text"  value='<?php echo $datos->nb?>'>                                 

<input  requiered class="input2" type="text"   name="nb" value='<?php echo $datos->ap?>'>
<br>
Cedula:
<br>
<input  requiered class="input2" type="text"   name='id_c' value='<?php echo $datos->id_c?>'>
<br>
Fecha de Nacimiento:
<br>
<input  requiered class="input2" type="text"   name="fec_n" value='<?php echo $datos->fc_n?>'>
...
<table class="tabla" width="721"  border="1" >
  <tr>
    <td  class="tabla_titulo3">Nº</td>
    <td class="tabla_titulo1" ><div align="center">Asignaturas</div></td>
    <td class="tabla_titulo1" >&nbsp;</td>
    <td  class="tabla_titulo2" >Nota</td>
  </tr>
  <tr>
    <td class="celda">1</td>
    <td  class="celda" ><select  name='asignatura_1' value='<?php echo $asignatura_1?>' class="selector"> class="selector">
    <option value="Castellano y Literatura">Castellano y Leteratura</option> 
</select></td>
    <td class="celda">&nbsp;</td>
    <td class="celda"><input  requiered name='nota_1'  value='<?php echo $datos->nota_1?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">2</td>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input  requiered name='nota_2'  value='<?php echo $datos->nota_2 ?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">3</td>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input  requiered  name='nota_3'  value='<?php echo $datos->nota_3 ?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">4</td>
    <td class="celda"><select name='asignatura_4'  value='<?php echo $asignatura_4?>' class="selector">
    <option  value="Matematica">Matematica</option> 
</select></td>
    <td class="celda">&nbsp;</td>
    <td class="celda"><input  requiered name='nota_4'  value='<?php echo $datos->nota_4 ?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">5</td>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input  requiered name='nota_5'  value='<?php  echo $datos->nota_5?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">6</td>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input  requiered name='nota_6'  value='<?php  echo $datos->nota_6?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">7</td>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input  requiered name='nota_7'  value='<?php  echo $datos->nota_7?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">8</td>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input  requiered name='nota_8'  value='<?php  echo $datos->nota_8?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">9</td>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input  requiered name='nota_9'  value='<?php  echo $datos->nota_9?>' class="input"></td>
  </tr>
  <tr>
...
<option  value="Tecnica y Pract. de  Adm y Tu"<?php if($datos->asignatura_10=="Tecnica y Pract. de  Adm y Tu") echo "selected";?>>Tecnica y Pract. de  Adm y Tu</option> 
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input  requiered  name='nota_10'  value='<?php  echo $datos->nota_10?>' class="input"></td>
  </tr>
  <tr>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input  requiered name='nota_11'  value='<?php  echo $datos->nota_11?>' class="input"></td>
  </tr>
  <tr>
   ...
   <option  value="Instruccion Premilitar">Instruccion Premilitar</option> 
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input  requiered name='nota_12'  value='<?php  echo $datos->nota_12?>' class="input"></td>
  </tr>
</table>

</div>

<input  requiered id="boton" type='submit' value='Modificar' >
</div>
