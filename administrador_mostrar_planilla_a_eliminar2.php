...
<script type="text/javascript">
    $(document).ready(function(){
        $('#Eliminar_evaluacion2').modal('show');
    });
</script>
...
<hr>
    ...
    <div  id="cedula" class="form-group">
      ...
      <label >Cedula:</label>
<br>
    <input required required type="text" name='id_c'  class="form-control" onFocus="nextfield ='nb';" onKeyPress="return validar(event)"  maxlength="8" placeholder="Cedula"    >
    </div>
...
<div class="modal fade" id="Eliminar_evaluacion2" role="dialog"  style="display:open;">
<div  id="modal-dialog_notas" class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title"><h2>Eliminar Evaluacion</h2> </div>
...
<br>
<input required class="input2" type="text"  value='<?php echo $datos->nb?>'>                                 

<input required class="input2" type="text"   name="nb" value='<?php echo $datos->ap?>'>
<br>
Cedula:
<br>
<input required class="input2" type="text"   name='id_c' value='<?php echo $datos->id_c?>'>
<br>
Fecha de Nacimiento:
<br>
<input required class="input2" type="text"   name="fec_n" value='<?php echo $datos->fc_n?>'>
...
<table class="tabla" width="721"  border="1" >
  ...
  <tr>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input required name='nota_1'  value='<?php echo $datos->nota_1?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">2</td>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input required name='nota_2'  value='<?php echo $datos->nota_2 ?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">3</td>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input required  name='nota_3'  value='<?php echo $datos->nota_3 ?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">4</td>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input required name='nota_4'  value='<?php echo $datos->nota_4 ?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">5</td>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input required name='nota_5'  value='<?php  echo $datos->nota_5?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">6</td>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input required name='nota_6'  value='<?php  echo $datos->nota_6?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">7</td>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input required name='nota_7'  value='<?php  echo $datos->nota_7?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">8</td>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input required name='nota_8'  value='<?php  echo $datos->nota_8?>' class="input"></td>
  </tr>
  <tr>
    <td class="celda">9</td>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input required name='nota_9'  value='<?php  echo $datos->nota_9?>' class="input"></td>
  </tr>
  <tr>
...
<option  value="Tecnica y Pract. de  Adm y Tu"<?php if($datos->asignatura_10=="Tecnica y Pract. de  Adm y Tu") echo "selected";?>>Tecnica y Pract. de  Adm y Tu</option> 
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input required  name='nota_10'  value='<?php  echo $datos->nota_10?>' class="input"></td>
  </tr>
  <tr>
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input required name='nota_11'  value='<?php  echo $datos->nota_11?>' class="input"></td>
  </tr>
  <tr>
   ...
   <option  value="Instruccion Premilitar">Instruccion Premilitar</option> 
    ...
    <td class="celda">&nbsp;</td>
    <td class="celda"><input required name='nota_12'  value='<?php  echo $datos->nota_12?>' class="input"></td>
  </tr>
</table>

</div>

<input required id="boton" type='submit' value='Eliminar' >
</div>
